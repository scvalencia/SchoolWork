...
Puede verse que aunque el documento *html*, mostrado para definir la página del profesor Soto no contiene la estructura minimal de un documento *html*, éste es desplegado por el navegadro, esto se debe a la falta de una estructura rígida sintáctica sobre *html*. El documento *HTML* con estilo minimal es:
